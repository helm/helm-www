...
And what we're going to do is... _remove them all!_ That way we can work through our tutorial from
...
The `helm get manifest` command takes a release name (`full-coral`) and prints out all of the
