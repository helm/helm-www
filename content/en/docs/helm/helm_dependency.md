...
* [helm dependency build](../helm_dependency_build)	 - rebuild the charts/ directory based on the Chart.lock file
* [helm dependency list](../helm_dependency_list)	 - list the dependencies for the given chart
* [helm dependency update](../helm_dependency_update)	 - update charts/ based on the contents of Chart.yaml
