...
As of Helm 2.5.0, it is possible to access list items using an array index syntax. For example,
...
In the above case, the `happy-panda` release is upgraded with the same chart, but with a new YAML
file:
