...
헬름 v3는 커뮤니티의 요구 사항을 충족하기 위해 헬름을 발전시키기 위한 지속적인 커뮤니티의 노력으로 [2019년 11월에 출시되었다](/blog/helm-3-released/). 간소화된 클라이언트 전용 환경, 보안에 대한 새로운 초점, 쿠버네티스 API와의 긴밀한 통합을 통하여 헬름 v3는 쿠버네티스에 대한 운영 테스트 패키지 관리를 계속 제공한다. 그리고 [졸업한 CNCF 프로젝트](/blog/celebrating-helms-cncf-graduation/)인 헬름은 클라우드 네이티브 생태계의 핵심부분이다.
