...
slug: securing-your-helm-installation
---
...
Once vetted, you can use Helm's provenance tools to [ensure the provenance and integrity of charts](../developing-charts/provenance.md) that you use.
