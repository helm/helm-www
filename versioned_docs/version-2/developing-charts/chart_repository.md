...
slug: the-chart-repository-guide
---
...
* Go through the [Quickstart](../using-helm/quickstart.md) Guide
* Read through the [Charts](../developing-charts/index.md) document
...
server, as are the [provenance files](../developing-charts/provenance.md).
