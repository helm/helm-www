...
- The Helm [Charts Guide](../developing-charts/index.md) explains the workflow of using charts.
- The Helm [Chart Hooks Guide](../developing-charts/charts_hooks.md) explains how to create lifecycle hooks.
- The Helm [Charts Tips and Tricks](../developing-charts/charts_tips_and_tricks.md) article provides some useful tips for writing charts.
