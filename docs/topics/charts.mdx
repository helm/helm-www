...
Helm 4 introduces `apiVersion: v3` for new charts. Charts with `apiVersion: v2`
continue to work unchanged. For migration guidance, see [Migrating Charts from
v2 to v3](/topics/chart_v2_v3_migration.md).
