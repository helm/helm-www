...
helm list --max <number>        # Limit the number of releases returned (default 256)
helm list --max 0               # Remove the limit to show all releases
helm list --offset <number>     # Skip the first N releases (for pagination)
