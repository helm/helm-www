...
helm install <name> <chart> --dependency-update       # update dependencies if they are missing or don't satisfy version constraints
...
helm upgrade <release> <chart> --dependency-update        # update dependencies if they are missing or don't satisfy version constraints
