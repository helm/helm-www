...
helm install <name> <chart> --force-replace           # Force resource install through a replacement strategy Helm (v4)
...
helm upgrade <release> <chart> --force-replace            # Force resource updates through a replacement strategy Helm (v4)
