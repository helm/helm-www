...
<CodeBlock language="go" title="sdkexamples/install.go" showLineNumbers>
  {InstallExampleGo}
</CodeBlock>
...
<CodeBlock language="go" title="sdkexamples/upgrade.go" showLineNumbers>
  {UpgradeExampleGo}
</CodeBlock>
...
<CodeBlock language="go" title="sdkexamples/uninstall.go" showLineNumbers>
  {UninstallExampleGo}
</CodeBlock>
...
<CodeBlock language="go" title="sdkexamples/list.go" showLineNumbers>
  {ListExampleGo}
</CodeBlock>
...
<CodeBlock language="go" title="sdkexamples/pull.go" showLineNumbers>
  {PullExampleGo}
</CodeBlock>
...
<CodeBlock language="go" title="sdkexamples/main.go" showLineNumbers>
  {MainExampleGo}
</CodeBlock>
