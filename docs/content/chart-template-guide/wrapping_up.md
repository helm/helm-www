...
- The Helm [Charts Guide](../developing-charts/#) explains the workflow of using charts.
- The Helm [Chart Hooks Guide](../developing-charts/#chart-lifecycle-hooks) explains how to create lifecycle hooks.
- The Helm [Charts Tips and Tricks](../developing-charts/#chart-tips-tricks) article provides some useful tips for writing charts.
