...
Helm uses a packaging format called _charts_. A chart is a collection of files that describe a related set of Kubernetes resources. A single chart
...
few other [specialized functions](../developing-charts/#chart-tips-tricks).
...
as required in the chart template by using the ['required' function](../developing-charts/#chart-tips-tricks)
