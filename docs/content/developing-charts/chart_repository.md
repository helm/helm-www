...
* Go through the [Quickstart](../using-helm/#quick-start) Guide
* Read through the [Charts](../developing-charts/#) document
...
server, as are the [provenance files](../developing-charts/#signing-charts).
...
![Create a GCS Bucket](../using-helm/images/create-a-bucket.png)

Next, make your bucket public by **editing the bucket permissions**.

![Edit Permissions](../using-helm/images/edit-permissions.png)

Insert this line item to **make your bucket public**:

![Make Bucket Public](../using-helm/images/make-bucket-public.png)
...
![Create Github Pages branch](../using-helm/images/create-a-gh-page-button.png)
...
![Create Github Pages branch](../using-helm/images/set-a-gh-page.png)
...
[example workflow](../developing-charts/#syncing-your-chart-repo) using the gsutil client. For
