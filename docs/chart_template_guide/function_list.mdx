...
[durationDays](#durationdays), [durationHours](#durationhours),
[durationMicroseconds](#durationmicroseconds),
[durationMilliseconds](#durationmilliseconds),
[durationMinutes](#durationminutes),
[durationNanoseconds](#durationnanoseconds), [durationRound](#durationround),
[durationRoundTo](#durationroundto), [durationSeconds](#durationseconds),
[durationTruncateTo](#durationtruncateto), [durationWeeks](#durationweeks),
[htmlDate](#htmldate), [htmlDateInZone](#htmldateinzone),
[mustToDuration](#musttoduration), [now](#now), [toDate
...
Rounds a duration to the nearest multiple of another duration. The duration to
round is the first argument and the multiple is the second.

**Go equivalent:** `time.Duration.Round()`

This returns 1h20m0s

```
durationRoundTo "1h15m30s" "10m"
```

This returns 2h0m0s

```
durationRoundTo "2h29m" "1h"
```
...
Truncates a duration toward zero to a multiple of another duration. The duration
to truncate is the first argument and the multiple is the second.

**Go equivalent:** `time.Duration.Truncate()`

This returns 1h10m0s

```
durationTruncateTo "1h15m30s" "10m"
```

This returns 2h0m0s

```
durationTruncateTo "2h59m" "1h"
```
...
`mustToDuration` parses a duration-like value into a `time.Duration` and causes a template failure on error.
