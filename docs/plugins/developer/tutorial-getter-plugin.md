...
1. Install the latest Helm 4 pre-release: **<GetVersion majorVersion="4" label={false} link={true} />**
2. In your terminal session, alias `helm` to the pre-release you downloaded. `helm version --short` should now show the correct Helm version in this terminal session.
