...
Зверніть увагу, як ми виконуємо відступ вище: `nindent 2` говорить шаблонному двигуну додати новий рядок і відступити кожен рядок у "myfile.txt" на два пробіли. `{{-` видаляє пробіли ліворуч, а `nindent` знову додає новий рядок з правильним відступом.
