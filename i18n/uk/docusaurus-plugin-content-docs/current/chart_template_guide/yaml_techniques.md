...
Зверніть увагу, як ми робимо відступ вище: `nindent 2` вказує рушію шаблонів додати новий рядок і зробити відступ у два пробіли в кожному рядку файлу «myfile.txt». `{{-` видаляє пробіли зліва, а `nindent` знову додає новий рядок із правильним відступом.
