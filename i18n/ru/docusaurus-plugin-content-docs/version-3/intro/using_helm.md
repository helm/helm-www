...
кластере Kubernetes. Руководство предполагает, что вы уже [установили](/intro/install.md) Helm CLI.

Если вы просто заинтересованы в нескольких командах, то можете начать с [Краткого Руководства](/intro/quickstart.md). В этой главе
