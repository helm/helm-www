...
Σημειώστε πώς κάνουμε την εσοχή παραπάνω: το `nindent 2` λέει στη μηχανή template
να προσθέσει μια νέα γραμμή και εσοχή δύο κενών σε κάθε γραμμή του "myfile.txt".
Το `{{-` αφαιρεί το κενό διάστημα στα αριστερά, και το `nindent` προσθέτει ξανά
τη νέα γραμμή με τη σωστή εσοχή.
