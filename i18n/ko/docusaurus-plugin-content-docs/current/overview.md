...
API에 관해 호환성이 깨지는 변경 작업이 전부 완료되었습니다. 테스트하고, 고장내보고, 피드백을 주세요! 이 API는 추가적인 차트 버전을 

API의 호환성 깨짐(breaking changes) 작업이 이제 완료되었습니다. 자유롭게 테스트하고, 문제를 발견하면 피드백을 보내주세요! 또한 이 API는 추가적인 Chart 버전을 지원하여, 향후 출시될 차트 v3에서 새로운 기능을 도입할 수 있는 기반을 제공합니다.
