...
---
تحميل الـ manifest لإصدار محدد

### الملخص

يقوم هذا الأمر بجلب الـ manifest الناتج لإصدار محدد.

الـ manifest هو تمثيل مشفر بصيغة YAML للموارد Kubernetes الناتجة من الـ chart أو الـ charts لذلك الإصدار. إذا كان أحد الـ charts يعتمد على charts أخرى، فستتم أيضًا تضمين هذه الموارد ضمن الـ manifest.
...
-h, --help مساعدة لأمر get manifest
