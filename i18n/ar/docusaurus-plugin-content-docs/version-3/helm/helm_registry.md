...
title: helm registry
---
تسجيل الدخول أو الخروج من سجل (Registry)

### الوصف

يتكون هذا الأمر من عدة أوامر فرعية للتفاعل مع السجلات (Registries).

### الخيارات

-h, --help مساعدة لأمر registry
...
* [helm registry login](/helm/helm_registry_login.md) - تسجيل الدخول إلى سجل
* [helm registry logout](/helm/helm_registry_logout.md) - تسجيل الخروج من سجل
