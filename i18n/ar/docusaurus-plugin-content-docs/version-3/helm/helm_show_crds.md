...
---
عرض CRDs الخاصة بالـ chart

### الملخص

يقوم هذا الأمر بفحص chart (مجلد، ملف أو رابط URL) ويعرض محتوى ملفات الـ CustomResourceDefinition (CRDs).
...
* [helm show](/helm/helm_show.md) - عرض المعلومات عن الـ chart
